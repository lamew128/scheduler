...
import { render, cleanup, fireEvent, getByPlaceholderText, getByTestId, getByText, queryByText } from "@testing-library/react";
...
describe("Form", () => {
  ...
  it("calls onSave function when the name is defined", () => {
    ...
    const { getByText, queryByText } = render(<Form interviewers={interviewers} interviewer={interviewers[0].id} student="Lydia Miller-Jones" onSave={onSave}/>);
    /* 3. Click the save button */
    fireEvent.click(getByText("Save"));
